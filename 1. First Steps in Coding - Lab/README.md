# Задача 1 - Конзолна програма "Hello SoftUni"
...
---
# Задача 3 - Пресмятане на лице на правоъгълник
...
---
# Задача 4 - Конвертор: инчове към сантиметри
...
---
# Задача 6 - Съединяване на текст и числа
...
---
# Задача 9 - Озеленяване на дворове
